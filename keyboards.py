...
def admin_main_kb():
    ...
    b.row(KeyboardButton(text="🎨 Sertifikat dizaynlari"), KeyboardButton(text="👥 Foydalanuvchilar"))
    b.row(KeyboardButton(text="👨‍💼 Adminlar"), KeyboardButton(text="📣 Xabar yuborish"))
